...
import hi.hugbo.verywowchat.controllers.NotMemberManageChatroomActivity;
...
public class SearchChatroomItemAdapter extends RecyclerView.Adapter {
        ...
        public void bind(final Chatroom chatroom) {
            ...
            BtnManageChatroom.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    context.startActivity(NotMemberManageChatroomActivity.newIntent(
