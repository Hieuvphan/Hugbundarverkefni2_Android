...
public class ChatroomAdminInviteItemAdapter extends RecyclerView.Adapter {
    ...
    public ChatroomAdminInviteItemAdapter(List<Chatroom> chatrooms) {
        ...
        public void bind(final Chatroom chatroom) {
            ...
            invite_accept.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try{
                        chatroomService.acceptAdminInvite(token, mChatroomName);
            ...
            invite_reject.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try{
                        chatroomService.declineChatroomAdminInvite(token, mChatroomName);
